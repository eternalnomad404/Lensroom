...
const handleSkuChange = (count: number) => {
if (count < 10) {
...
<img src="https://readdy.ai/api/search-image?query=professional%20headshot%20of%20a%20male%20photographer%20with%20a%20modern%20camera%2C%20wearing%20casual%20professional%20attire%2C%20natural%20lighting%2C%20studio%20background%2C%20high%20quality%20portrait&width=64&height=64&seq=1&orientation=squarish" alt="Photographer" className="w-full h-full rounded-full object-cover" />
</div>
<div>
...
Service fee is fully refundable if shoot is cancelled
</div>
</div>
)}
...
{/* Proceed Button */}
<button className="w-full bg-yellow-500 text-white py-3 rounded-button font-medium hover:bg-yellow-600 transition-colors whitespace-nowrap cursor-pointer">
